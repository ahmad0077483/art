                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-footer">
                                    <a class="text-center" href="#">همه صفحات</a>
                                </li>
                            </ul>
                        </li>
                        <!-- User Account -->
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                    <a href="{{route('profile.update')}}">
                                        <i class="mdi mdi-account"></i>پروفایل
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#"> <i class="mdi mdi-diamond-stone"></i> پروژه ها </a>
                                </li>
                                <li>
                                    <a href="#"> <i class="mdi mdi-settings"></i> تنظیمات حساب </a>
                                </li>
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
                <p>
                    ...
                    <a class="text-primary" href="http://www.iamabdus.com/" target="_blank"></a>
