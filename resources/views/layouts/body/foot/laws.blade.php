...
<div class="row">
    ...
    <div class="content col-md-offset-12 col-lg-offset-12">
        <center><h1 style=" text-decoration:none;" class="contentHead"> قوانین </h1></center>
        ...
        <h1 class="text-dark"><br/><br/><span class="text-dark">
            ...
            <br/><br/>
            <br/><br/>
            <h3 class="text-dark">{{$laws->short_dis}}</h3>
            <p class="text-dark"><span
                    style="text-align:right; color:#000000; font-size:18px;">{{$laws->long_dis}}</span></p>
        </h1>
    </div>
</div>
<a href="{{asset('/')}}" class="btn btn-light btn justify-content-center "><span
        class="material-icons icon-back  justify-content-center ">
arrow_back
</span></a>
</body>
</html>
